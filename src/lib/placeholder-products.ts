...
export const PRODUCTS: Product[] = [
  {
    ...
    sizes: ['XS','S','M'], condition: 'like_new', store_type: 'feria', category: 'mujer', subcategory: 'ropa',
    seller: SELLER_MARIA, accepts_offers: true, free_shipping: false, created_at: '2026-06-20T10:00:00Z',
  },
  {
    ...
    sizes: ['S','M','L'], condition: 'new_tag', store_type: 'feria', category: 'mujer', subcategory: 'ropa',
    seller: SELLER_SOF, accepts_offers: false, free_shipping: false, created_at: '2026-06-19T14:00:00Z',
  },
  {
    ...
    sizes: ['S','M','L','XL'], condition: 'like_new', store_type: 'feria', category: 'mujer', subcategory: 'ropa',
    seller: SELLER_LARA, accepts_offers: true, free_shipping: false, created_at: '2026-06-18T09:00:00Z',
  },
  {
    ...
    sizes: ['XS','S','M','L'], condition: 'new_tag', store_type: 'oficial', category: 'mujer', subcategory: 'ropa',
    seller: SELLER_OFICIAL, accepts_offers: false, free_shipping: true, created_at: '2026-06-17T11:00:00Z',
  },
  {
    ...
    sizes: ['Único'], condition: 'new', store_type: 'feria', category: 'mujer', subcategory: 'calzado',
    seller: SELLER_MARIA, accepts_offers: true, free_shipping: false, created_at: '2026-06-16T16:00:00Z',
  },
  {
    ...
    sizes: ['S','M','L','XL'], condition: 'new_tag', store_type: 'oficial', category: 'mujer', subcategory: 'ropa',
    seller: SELLER_OFICIAL, accepts_offers: false, free_shipping: true, created_at: '2026-06-15T10:00:00Z',
  },
  {
    ...
    sizes: ['S','M'], condition: 'used', store_type: 'feria', category: 'mujer', subcategory: 'accesorios',
    seller: SELLER_SOF, accepts_offers: true, free_shipping: false, created_at: '2026-06-14T13:00:00Z',
  },
  {
    ...
    sizes: ['XS','S'], condition: 'like_new', store_type: 'feria', category: 'mujer', subcategory: 'belleza',
    seller: SELLER_LARA, accepts_offers: true, free_shipping: false, created_at: '2026-06-13T10:00:00Z',
  },
  {
    ...
    sizes: ['36','38','40'], condition: 'like_new', store_type: 'feria', category: 'mujer', subcategory: 'ropa',
    seller: SELLER_MARIA, accepts_offers: false, free_shipping: true, created_at: '2026-06-12T09:00:00Z',
  },
  {
    ...
    sizes: ['XS','S','M','L','XL'], condition: 'new_tag', store_type: 'oficial', category: 'mujer', subcategory: 'ropa',
    seller: SELLER_OFICIAL, accepts_offers: false, free_shipping: true, created_at: '2026-06-11T14:00:00Z',
  },
  {
    ...
    sizes: ['M','L'], condition: 'used', store_type: 'feria', category: 'hombre', subcategory: 'calzado',
    seller: SELLER_SOF, accepts_offers: true, free_shipping: false, created_at: '2026-06-10T10:00:00Z',
  },
  {
    ...
    sizes: ['XS','S','M'], condition: 'new_tag', store_type: 'oficial', category: 'mujer', subcategory: 'ropa',
    seller: SELLER_OFICIAL, accepts_offers: false, free_shipping: true, created_at: '2026-06-09T11:00:00Z',
  },
  {
    id: 'p13', title: 'Vela aromática sage & cedar', brand: 'La Percha', price: 4800,
    description: 'Vela de soja artesanal perfumada con sage y cedro. 200g, quema 40 horas. Presentación gift en caja kraft. Producción local.',
    images: [
      'https://images.unsplash.com/photo-1602607144289-dcc40cc61b90?w=600&h=800&fit=crop',
      'https://images.unsplash.com/photo-1612817288484-6f916006741a?w=600&h=800&fit=crop',
    ],
    sizes: ['Único'], condition: 'new_tag', store_type: 'oficial', category: 'regaleria',
    seller: SELLER_OFICIAL, accepts_offers: false, free_shipping: true, created_at: '2026-06-08T10:00:00Z',
  },
  {
    id: 'p14', title: 'Set tazas cerámica artesanal', brand: 'La Percha', price: 8900,
    description: 'Set de 2 tazas en cerámica esmaltada a mano. Tonos sage y taupe. Cada una es única. Apto lavavajillas. Capacidad 250ml.',
    images: [
    ...
    sizes: ['Único'], condition: 'new_tag', store_type: 'oficial', category: 'bazar',
    seller: SELLER_OFICIAL, accepts_offers: false, free_shipping: true, created_at: '2026-06-07T10:00:00Z',
  },
  {
    id: 'p15', title: 'Maceta colgante fibra natural', brand: 'La Percha', price: 6200,
    description: 'Maceta colgante tejida a mano en fibra de yute natural. Porta maceta 12cm. Perfecta para cactus y suculentas. Incluye gancho.',
    images: [
    ...
    sizes: ['Único'], condition: 'new_tag', store_type: 'oficial', category: 'decoracion',
    seller: SELLER_OFICIAL, accepts_offers: false, free_shipping: true, created_at: '2026-06-06T10:00:00Z',
  },
]
